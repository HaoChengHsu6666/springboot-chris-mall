package com.chrishsu.springbootchrismall.dao.impl;
...
import com.chrishsu.springbootchrismall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        Integer total = namedParameterJdbcTemplate.queryForObject(sql, map, Integer.class);//將count的值轉回成Interger類型的返回值
